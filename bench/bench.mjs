...
//
// The backdrop sweep is the real implementation from public/backdrop.js
// (no DOM steps: innerHTML write and scroll sync are browser costs, eyeballed
// once in the browser, not gated).
//
